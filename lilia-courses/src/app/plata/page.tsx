    ...
    <div className="flex min-h-screen w-full flex-col overflow-x-hidden text-[#2A1F18]" style={{ backgroundColor: '#FAF7F2' }}>
      ...
      <main className="mx-auto grid w-full max-w-[1040px] flex-1 grid-cols-1 gap-10 px-4 py-12 sm:px-6 md:grid-cols-2 md:gap-12 md:py-14">
        ...
        <div className="order-2 md:order-1">
          ...
          <div className="relative rounded-xl border bg-white p-6" style={{ borderColor: '#DDD4C4' }}>
            <div className="absolute left-5 top-6 font-serif text-[64px] leading-[0.6] text-[#DDD4C4]" style={serif}>
              &ldquo;
            </div>
            <div className="mb-3 pl-2 text-sm tracking-widest text-[#D4935A]">★★★★★</div>
            <p className="relative z-10 mb-4 pt-6 text-[17px] italic leading-relaxed text-[#7A5C48]" style={serif}>
              Am aplicat primul exercițiu din lecția 3 chiar în acea seară. A fost prima dată în doi ani când soțul meu m-a ascultat
              până la capăt, fără să se apere.
            </p>
            <p className="text-xs font-medium uppercase tracking-wide text-[#9C7E6F]">— Andreea M., participantă la curs</p>
          </div>
        </div>
